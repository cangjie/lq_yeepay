<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MobilePay.aspx.cs" Inherits="MobilePay" %>
...
<body>
    ...
    <div class="content2">
        ...
        <ul>
            ...
            <li><asp:Button ID="Button1"  runat="server" AccessKey="A" Text="去移动终端网页支付" OnClick="MobilePay_Click" /></li>
       </ul>
    </div>
    </form>
</body>
